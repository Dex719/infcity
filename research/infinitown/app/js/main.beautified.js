! function t(e, n, r) {
    ...
    3: [function(t, e, n) {
        var r = {
                ...
                off: function(t, e, n) {
                    ...
                    for (a = t ? [t] : _.keys(this._events), c = 0, u = a.length; c < u; c++)
                        if (t = a[c], o = this._events[t]) {
                            if (this._events[t] = r = [], e || n)
                                for (l = 0, f = o.length; l < f; l++) i = o[l], (e && e !== i.callback && e !== i.callback._callback || n && n !== i.context) && r.push(i);
    ...
    4: [function(t, e, n) {
        ...
        r.CreateWhiteTexture = function(t, e) {
            ...
            var n = t * e * 3,
                r = new Uint8Array(n),
                i = new THREE.DataTexture(r, t, e, THREE.RGBFormat);
    ...
    13: [function(t, e, n) {
        var r = (t("21"), t("22")),
            i = t("20"),
            o = (t("15"), THREE.MaterialLoader.prototype.parse),
            a = null;
    ...
    15: [function(t, e, n) {
        ...
        var s = t("24"),
            ...
            v = new u(d),
            m = {},
            g = r(new THREE.TextureLoader(d), m),
            y = r(new l(1024, (!1), d), m),
            b = r(new f(256, (!1), d), m),
            w = {},
            x = new h(d),
            E = {},
            ...
            parseImages: function(t, e) {
                ...
                if (void 0 !== t && t.length > 0) {
                    ...
                    for (var s = 0, c = t.length; s < c; s++) {
                        var u = t[s],
                            l = /^(\/\/)|([a-z]+:(\/\/)?)/i.test(u.url) ? u.url : r.texturePath + u.url;
                        i[u.uuid] = n(l)
                    }
                }
                return i
                ...
                return function(e, n, r) {
                    ...
                    if ("LOD" === e.type)
                        for (var l = e.levels, f = 0; f < l.length; f++) {
                            var h = l[f],
                                u = a.getObjectByProperty("uuid", h.object);
    ...
    22: [function(t, e, n) {
        ...
        c.inherit(i, {
            ...
            var n = a.CreateWhiteTexture(),
                i = a.CreateNormalTexture(),
                s = t.albedoMap || n,
                u = t.albedoMap2 || n,
                l = t.normalMap || i,
                f = t.normalMap2 || i,
                ...
                return function o(t, e, n) {
                    ...
                    9: [function(e, n, r) {
                        ...
                        n.exports = function(n, r) {
                            ...
                            function m(t, e, n, r, i) {
                                if (void 0 === t && null !== e && $) {
                                    ...
                                    if (e._trace) {
                                        ...
                                        if (c.length > 0)
                                            for (var h = c[0], u = 0; u < s.length; ++u)
                                                if (s[u] === h) {
                                                    u > 0 && (a = "\n" + s[u - 1]);
                                                    break
                                                }
                            ...
                            var ot = function() {
                                ...
                                var r = new Error;
                                if ("string" == typeof r.stack && r.stack.split("\n")[0].indexOf("stackDetection@") >= 0) return G = /@/, X = e, Y = !0,
                                    function(t) {
                    ...
                    22: [function(e, n, r) {
                        ...
                        n.exports = function() {
                            ...
                            var w = function() {},
                                ...
                                E = {},
                                T = e("./thenables")(o, w),
                                R = e("./promise_array")(o, w, T, h, r),
                                C = e("./context")(o),
                                M = C.create,
                                S = e("./debuggability")(o, C),
                                O = (S.CapturedTrace, e("./finally")(o, T, E)),
                                P = e("./catch_filter")(E),
                                L = e("./nodeback"),
                                A = d.errorObj,
                                k = d.tryCatch;
                            return o.prototype.toString = function() {
                                ...
                                c: 3
                            }), c(1), c(function() {}), c(void 0), c(!1), c(new o(w)), S.setBounds(m.firstLineError, d.lastLineError), o
                        }
                    }, {
                        "./any.js": 1,
                        "./async": 2,
                            ...
                            l.prototype.data = function() {
                                ...
                                for (var c = new p(t), f = 0; f < t; ++f) {
                                    ...
                                    if (l.isDisposer(v)) {
                                        ...
                                        var y = r(v);
                                        y instanceof e && (v = y._then(h, null, null, {
                                            resources: c,
                                            index: f
                                        }, void 0))
                                    }
                    ...
                    36: [function(e, n, i) {
                        ...
                        var S = e("./es5"),
                            ...
                            L, A = "undefined" != typeof self ? self : "undefined" != typeof window ? window : "undefined" != typeof r ? r : void 0 !== this ? this : null,
                            k = function(t, e) {
                                function n() {
    ...
    26: [function(t, e, n) {
        (function(t) {
            ...
            n.resolve = function() {
                ...
                for (var i = r(t.split("/")), o = r(e.split("/")), a = Math.min(i.length, o.length), s = a, c = 0; c < a; c++)
                    if (i[c] !== o[c]) {
                        s = c;
                        break
        ...
        (function(t) {
            (function() {
                ...
                function T(t) {
                    ...
                    function Kt(t, e) {
                        var n = t.data,
                            r = "string" == typeof e || Fi(e) ? n.set.has(e) : n.hash[e];
                        return r ? 0 : -1
                    }
                    ...
                    function ze(t, e, n, r, i) {
                        if (!Fi(t)) return t;
                        var o = Kn(e) && (Os(e) || Vi(e)),
                            a = o ? R : Us(e);
                        return ee(a || e, function(s, c) {
                            if (a && (c = s, s = e[c]), g(s)) r || (r = []), i || (i = []), Be(t, e, c, ze, n, r, i);
                            else {
                                var u = t[c],
                                    l = n ? n(u, s, c, t, e) : R,
                                    f = l === R;
                    ...
                    function on(t, e, n, r) {
                        ...
                        for (var i = 0, o = t ? t.length : 0, a = e !== e, s = null === e, c = e === R; i < o;) {
                            var u = _a((i + o) / 2),
                                ...
                                h = l === l;
                            if (a) var p = h || r;
                            else p = s ? h && f && (r || null != l) : c ? h && (r || f) : null != l && (r ? l <= e : l < e);
                            p ? i = u + 1 : o = u
                        }
                        return Ea(o, Pa)
                    }
                    ...
                    function Hn(t, e, n, r, i, o, a, s) {
                        ...
                        if (h && (ir(p, h), e = p[1], s = p[9]), p[9] = null == s ? c ? 0 : t.length : xa(s - u, 0) || 0, e == M) var d = dn(p[0], p[2]);
                        else d = e != A && e != (M | A) || p[4].length ? An.apply(R, p) : Fn.apply(R, p);
                        var v = h ? Ua : Va;
                        return v(d, p)
                    }
                    ...
                    function Mr(t, e, n) {
                        ...
                        if (!r) return -1;
                        var i = r;
                        if ("number" == typeof n) i = (n < 0 ? xa(r + n, 0) : Ea(n || 0, r - 1)) + 1;
                        else if (n) {
                            i = rn(t, e, !0) - 1;
                            var o = t[i];
                    ...
                    function pi(t, e, n) {
                        ...
                        function s() {
                            if (c = arguments, f = vs(), h = this, d = g && (p || !_), m === !1) var n = _ && !p;
                            else {
                                u || _ || (v = f);
                                var r = m - (f - v),
                                    i = r <= 0 || r > m;
                    ...
                    function gi(t, e) {
                        if ("function" != typeof t) throw new $o(V);
                        return e = xa(e === R ? t.length - 1 : +e || 0, 0),
                            function() {
                    ...
                    function yo(t, n, r) {
                        ...
                        var o, a, c = me(ge({}, n.imports), i.imports, ve),
                            u = Us(c),
                            l = tn(c, u),
                            f = 0,
                            h = n.interpolate || Ht,
                    ...
                    var zo = t.Array,
                        ...
                        Ra = t.parseInt,
                        Ca = Xo.random,
                        Ma = Yo.NEGATIVE_INFINITY,
                        Sa = Yo.POSITIVE_INFINITY,
                        Oa = 4294967295,
                        Pa = Oa - 1,
                        La = Oa >>> 1,
                        Aa = 9007199254740991,
                ...
                var Gt = {
                    ...
                    $t = qt[typeof n] && n && !n.nodeType && n,
                    Kt = qt[typeof e] && e && !e.nodeType && e,
                    Qt = $t && Kt && "object" == typeof t && t && t.Object && t,
                    Jt = qt[typeof self] && self && self.Object && self,
                    te = qt[typeof window] && window && window.Object && window,
                    ee = Kt && Kt.exports === $t && $t,
                    ne = Qt || te !== (this && this.window) && te || Jt || this,
                    re = T();
    ...
    42: [function(t, e, n) {
        ! function(n, r) {
            function i(t, e, i) {
                ...
                var h = c(s(e.entropy ? [t, l(n)] : null == t ? u() : t, 3), f),
                    v = new o(f),
                    b = function() {
    ...
    43: [function(t, e, n) {
        ...
        f.inherit(r, {
            start: function(t) {
                var e = t.getObjectByName("blocks").children,
                    n = t.getObjectByName("lanes").children,
                    o = t.getObjectByName("intersections").children,
                    l = t.getObjectByName("cars").children,
            ...
            refreshChunkScene: function() {
                this.chunkScene.forEachChunk(function(t, e, n) {
                    var r = this.gridCoords.x + e,
                        i = this.gridCoords.y + n,
                        o = this.table.getChunkData(r, i);
    ...
    46: [function(t, e, n) {
        ...
        a.inherit(i, {
            ...
            _initCollisionPoints: function() {
                ...
                n.copy(t.max), this.worldToLocal(n), n.y = 1, Math.abs(this.direction.x) > 0 ? n.z = 0 : n.x = 0, this.collisionPoints = [e, n], this.collisionPoints.forEach(function(t) {}, this)
            },
    ...
    47: [function(t, e, n) {
        ...
        i.inherit(THREE.Scene, {
            _initChunks: function() {
                for (var t = 0; t < r.CHUNK_COUNT; t++)
                    for (var e = 0; e < r.CHUNK_COUNT; e++) {
            ...
            _createChunkAt: function(t, e) {
                var n = new THREE.Object3D,
                    i = new THREE.PlaneGeometry(r.CHUNK_SIZE, r.CHUNK_SIZE, 1, 1),
                    o = new THREE.MeshBasicMaterial,
                    a = new THREE.Mesh(i, o),
                    s = (r.CHUNK_COUNT - 1) / 2 * -r.CHUNK_SIZE,
                    c = s;
        ...
        c.inherit(Object, {
            ...
            _getRandomChunk: function(t, e) {
                var n = new THREE.Matrix4,
                    c = (new THREE.Matrix4).makeRotationY(Math.PI / 2),
                    u = new THREE.Object3D;
                u.name = "chunk";
                var l = this._getRandomBlockAt(t, e),
                    f = Math.round(4 * s.random()) * (Math.PI / 2);
                l.rotation.y = f, l.position.set(0, 0, 0), u.add(l), u.block = l;
                var h = [],
                    p = r(this.lanes).clone();
                ...
                if (_.position.set(-30, 0, 30), u.add(_), h.forEach(function(t) {
                        ...
                        if (s.random() < e) {
                            var n = r(this.carObjects).clone(),
                                i = new o(this, n, t);
                            u.add(i), this.mobs.push(i)
                        }
                    }, this), s.random() > .65) {
                    var y = r(this.cloudObjects).clone(),
                        b = new a(this, y);
            ...
            _generate: function() {
                for (var t = 0; t < i.TABLE_SIZE; t++)
                    for (var e = 0; e < i.TABLE_SIZE; e++) {
                        void 0 === this.chunks[e] && (this.chunks[e] = []);
                        var n = this._getRandomChunk(e, t);
                        n.tableX = e, n.tableY = t, this.chunks[e][t] = {
                            node: n
                        }
                    }
            }
    ...
    52: [function(t, e, n) {
        ...
        var o = function(t) {
            ...
            $(t).on("mousedown", function(t) {
                ...
                if (2 === t.touches.length) e = !0, n = r(t.originalEvent.touches), this.trigger("pinchstart");
    ...
    55: [function(t, e, n) {
        var r = t("50"),
            i = t("59"),
            o = r.CHUNK_SIZE * r.TABLE_SIZE,
            a = THREE.Math.euclideanModulo,
            s = function(t) {
        ...
        s.inherit(THREE.Object3D, {
            _updateTablePosition: function() {
                ...
                var n = Math.floor(a(this.tablePosition.x + 40, o) / r.CHUNK_SIZE),
                    s = Math.floor(a(this.tablePosition.z + 40, o) / r.CHUNK_SIZE),
                    c = this.parent,
                ...
                if (Math.abs(t) < 500 && Math.abs(t) > 20 && console.log("warp on X", t, c.tableX, u.tableX), Math.abs(e) < 500 && Math.abs(e) > 20 && console.log("warp on Z", e, c.tableY, u.tableY), this.previousChunk !== c && c !== u, this.lastPosition.copy(this.position), u !== c) {
                    u.add(this);
                    var l = a(this.position.x + 40, r.CHUNK_SIZE) - 40,
    ...
    56: [function(t, e, n) {
        var r = THREE.OrthographicCamera,
            i = (t("7"), function(t) {
                r.call(this);
