...
мощёные площади, стадион с открытой чашей и разметкой поля, мягкая тень у ландмарков; облака
...
попадают всё равно), поэтому кадр укладывается в 320 тысяч треугольников из 400 тысяч
