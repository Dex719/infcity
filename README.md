...
маркизы магазинов и кафе-террасы под зонтиками, ряды кондиционеров и фонари на крышах торговых
центров, мягкая тень у ландмарков; белые мягкие облака растворяются у низкой камеры, а их тени
...
попадают всё равно), поэтому кадр укладывается в 329 тысяч треугольников из 400 тысяч
и 127 draw calls из 300.
...
```bash
npm run test       # Vitest, один прогон (361 тест)
