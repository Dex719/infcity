...
поясами-плитами новостроек и сеткой навесных стен, мощёные площади, стадион с открытой чашей и
разметкой поля, полосатые маркизы магазинов и кафе-террасы под зонтиками, ряды кондиционеров на
больших крышах и фонари на торговых центрах, мягкая тень у ландмарков и у набережных; белые мягкие
облака растворяются у низкой камеры, а их тени остаются. Тон подобран расчётной моделью освещения и
сверен с замером пикселей кадра.
...
```bash
npm run test       # Vitest, один прогон (372 теста)
