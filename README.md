...
Мелкие детали лежат в отдельном слое геометрии и гаснут на дальних чанках прямо в тумане, без
пересборки: переключается только видимость готового меша, поэтому панорамирование и зум остаются
бесплатными. Кадр укладывается в 260 тысяч треугольников из 400 тысяч и 124 draw calls из 300.
...
```bash
npm run test       # Vitest, один прогон (267 тестов)
