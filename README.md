...
парковки; дома — с цоколями, карнизами, балконами, входными группами и витринами. В центре
старта — бульвар Нуржол между Байтереком и Хан Шатыром: фонтаны с каналами на оси, тенистые
ряды деревьев, газоны и клумбы.

Картинка выведена к уровню Infinitown: мягкая тень у подножия зданий и вокруг них запечена прямо в
вершинные цвета (как AO у референса, только без текстур), формы гранёные, кадр «высокого ключа» —
светлые тротуары, сочные газоны, «зебры» во всю ширину улиц с четырёх сторон перекрёстков, серые
крыши с цветными парапетами, фасады с тёмными проёмами окон, поясами-плитами новостроек и сеткой
навесных стен, мощёные площади с газонными островами, рынки с зелёными краями, дворы с детскими
площадками, стадион с открытой чашей и разметкой поля, полосатые маркизы магазинов и кафе-террасы
под зонтиками, ряды кондиционеров на больших крышах и фонари на торговых центрах, мягкая тень у
ландмарков и у набережных; белые мягкие облака растворяются у низкой камеры, а их тени остаются.
Тон подобран расчётной моделью освещения и сверен с замером пикселей кадра.
...
попадают всё равно), поэтому кадр укладывается в 340 тысяч треугольников из 400 тысяч
...
```bash
npm run test       # Vitest, один прогон (408 тестов)
