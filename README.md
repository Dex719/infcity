...
светлые тротуары, сочные газоны, тёмные крыши с цветными парапетами, фасады с отдельными окнами,
мощёные площади. Тон подобран расчётной моделью освещения и сверен с замером пикселей кадра.
...
бесплатными. Кадр укладывается в 258 тысяч треугольников из 400 тысяч и 123 draw calls из 300.
