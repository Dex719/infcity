...
светлые тротуары, сочные газоны, серые крыши с цветными парапетами, фасады с отдельными окнами
и сеткой навесных стен, мощёные площади, стадион с открытой чашей и разметкой поля, полосатые
...
```bash
npm run test       # Vitest, один прогон (355 тестов)
