...
и кафе-террасы под зонтиками, мягкая тень у ландмарков; облака
...
попадают всё равно), поэтому кадр укладывается в 321 тысячу треугольников из 400 тысяч
и 125 draw calls из 300.
