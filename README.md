...
поясами-плитами новостроек и сеткой навесных стен, мощёные площади с газонными островами, стадион с
открытой чашей и разметкой поля, полосатые маркизы магазинов и кафе-террасы под зонтиками, ряды
...
```bash
npm run test       # Vitest, один прогон (374 теста)
