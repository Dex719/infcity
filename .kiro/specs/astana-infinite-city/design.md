...
| Ключ | Значение | Смысл |
|---|---|---|
| `WALL_MIN` | 0,55 | множитель цвета стены у основания (линейное пространство) |
| `WALL_HEIGHT` | 3 | высота, где затемнение стены сходит на нет (≈ этаж) |
| `GROUND_MIN` | 0,5 | множитель цвета земли у стены |
