...
| AC-6.2 | 0 машин со скоростью 0 дольше 10 с за 5 мин | `e2e/simulation.spec.ts` (stuck = 0), unit-симуляции; фазы перекрёстков 5 с, радар игнорирует удаляющиеся | ✅ |
...
- Публичный URL демо — после `git push` и включения GitHub Pages в репозитории.
