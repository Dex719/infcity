...
- [x] **TSK-136**: Обход всех типов кварталов и ландмарков на низкой камере; починка найденного
  ...
  - Факт: обход нашёл 2 дефекта (ландмарки — без замечаний); крона дерева теперь в 1,9 от изгороди; портал и парковка ТЦ на видимой стороне при всех 4 поворотах (unit), во встроенном браузере ТЦ на (−1, 0) стоит фасадом; unit 343/343
