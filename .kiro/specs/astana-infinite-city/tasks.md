...
- [ ] **TSK-116**: AO стен — `GeometryBatch.boxAo` на корпусах и цоколях
...
- [ ] **TSK-117**: AO земли — ореолы вокруг зданий
...
- [ ] **TSK-118**: Тон — экспозиция светом и палитра
...
- [ ] **TSK-119**: Окна отдельными проёмами
...
- [ ] **TSK-120**: Крыши — тёмная кровля и цветной парапет
...
- [ ] **TSK-121**: Мощение и зелёные вставки площадей
